    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.layout}>
                ...
                <Text> means the software program provided by the Company downloaded by You on any electronic device, named Go Play! - Montana Repertory Theatre</Text>
                ...
                <Text> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</Text>
                ...
                <Text> is any information that relates to an identified or identifiable individual.</Text>
                ...
                <Text> refers to any website or any social network website through which a User can log in or create an account to use the Service.</Text>


                <Text style={{ fontWeight: 'bold' }}>Usage Data</Text>
                <Text> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</Text>
                ...
                <Text style={styles.header}>Collecting and Using Your Personal Data</Text>
                ...
                <Text style={styles.subheader}>Tracking Technologies and Cookies</Text>
                ...
                <Text> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read &quot;Where can I change the settings for disabling, or deleting local shared objects?&quot; available at </Text>
                <TouchableOpacity onPress={() => {
                    ...
                    <Text>https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</Text>
                </TouchableOpacity>
                ...
                <Text>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies here:</Text>
                <TouchableOpacity onPress={() => {
                    Linking.openURL("https://www.termsfeed.com/blog/cookies/")
                        .catch(err => {
                            console.error("Failed opening page because: ", err);
                            alert('Failed to open page');
                        })
                }}>
                    <Text>All About Cookies by TermsFeed</Text>
                </TouchableOpacity>
                <Text>We use both Session and Persistent Cookies for the purposes set out below:</Text>


                <Text style={{ fontWeight: 'bold' }}>Necessary / Essential Cookies</Text>
                ...
                <Text style={{ fontWeight: 'bold' }}>Cookies Policy / Notice Acceptance Cookies</Text>
                ...
                <Text style={{ fontWeight: 'bold' }}>To provide and maintain our Service</Text>
                <Text>, including to monitor the usage of our Service.</Text>


                <Text style={{ fontWeight: 'bold' }}>To manage Your Account:</Text>
                <Text> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</Text>


                <Text style={{ fontWeight: 'bold' }}>For the performance of a contract:</Text>
                <Text> the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.</Text>
                ...
                <Text> with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</Text>
                ...
                <Text>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.</Text>
                ...
                <Text> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</Text>
                <Text style={{ fontWeight: 'bold' }}>For business transfers:</Text>
                <Text> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</Text>
                <Text style={{ fontWeight: 'bold' }}>With Affiliates:</Text>
                <Text> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</Text>
                <Text style={{ fontWeight: 'bold' }}>With business partners:</Text>
                <Text> We may share Your information with Our business partners to offer You certain products, services or promotions.</Text>
                ...
                <Text>: We may disclose Your personal information for any other purpose with Your consent.</Text>
                ...
                <Text style={styles.header}>Detailed Information on the Processing of Your Personal Data</Text>
                <Text>The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</Text>
                <Text style={styles.subheader}>Email Marketing</Text>
                <Text>We may use Your Personal Data to contact You with newsletters, marketing or promotional materials and other information that may be of interest to You. You may opt-out of receiving any, or all, of these communications from Us by following the unsubscribe link or instructions provided in any email We send or by contacting Us.</Text>
